...
const setup = ({ rootId, scroll, interval, infinite }: Props) => {
    ...
    (elements) =>
      elements.forEach((item) => {
        ...
        if (item.isIntersecting) {
          ...
          currentItem?.setAttribute("data-highlight", "");
        } else {
          dot?.removeAttribute("disabled");
          currentItem?.removeAttribute("data-highlight");
        }
      }),
  ...
  sliderElement.onwheel = handleMouseWheel;
